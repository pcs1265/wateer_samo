...
public class SwaggerConfiguration {
	...
	public OpenAPI openAPI() {
		Info info = new Info().title("SSAFY Trip_DC 명세서").description(
				"<h3>SSAFY Trip_DC API Reference for Developers</h3>Swagger를 이용한 API 명세서<br>")
				.version("v1").contact(new io.swagger.v3.oas.models.info.Contact().url("http://edu.ssafy.com"));
